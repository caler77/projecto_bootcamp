...
class Base(pg.sprite.Sprite):
    def __init__(self , screen , sprite , angleRotation = 16 , spriteCutWidth = 0 , spriteCutHeight = 0 ,  numColSpriteAnimation = 0 , numRowSpriteAnimation = 1 ):
        super().__init__()
        self.screen = screen
    ...
    def imput(self , dt ):
        ...
        if key[pg.K_d]:
            self.dir.x = 1 
            if 'right' in self.dir_hit:
                self.vel.x = 0
            else:
                self.vel.x = 1
        elif key[pg.K_a]:
            self.dir.x = -1 
            if 'left' in self.dir_hit:
                self.vel.x = 0
            else:
                self.vel.x = 1
        else:
        ...
        if key[pg.K_w]:
            self.dir.y = -1
            if 'top' in self.dir_hit:
                self.vel.y = 0
            else:
                self.vel.y = 1
        elif key[pg.K_s]:
            self.dir.y = 1 
            if 'bottom' in self.dir_hit:
                self.vel.y = 0
            else:
                self.vel.y = 1
        else:
    ...
    def Animation(self , dt , frameEnd = 0 , frameStart = 0 ):
        if frameEnd == 0:
        ...
        centerPrevius = self.rect.center
        self.currentAnimationTime += dt   
        self.animationTime = FPS * 2
        if self.currentAnimationTime > self.animationTime:
            self.currentAnimationTime = 0
            self.frameIndex +=1
